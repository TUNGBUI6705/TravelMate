...
//    Tích hợp OpenStreetMap / external map API attributes
// ═══════════════════════════════════════════════════════
const places = [
  {
    id: 'place_001',
    ...
    // ── Toạ độ (dùng hiển thị bản đồ) ────────────────
    location: { lat: 11.9404, lng: 108.4383 },
    // ── OpenStreetMap / Map API attributes ───────────
    osmMapsUrl: 'https://www.openstreetmap.org/?mlat=11.9404&mlon=108.4383&zoom=16',
    osmNodeId: 1234567890,                          // OpenStreetMap node ID
    mapProvider: 'openstreetmap',                   // "google" | "openstreetmap" | "manual"
    // ── Hình ảnh ──────────────────────────────────────
    images: [],
    coverImage: '',
    // ── Phân loại & tìm kiếm ─────────────────────────
  ...
  },
  {
    ...
    osmMapsUrl: 'https://www.openstreetmap.org/?mlat=16.0662&mlon=108.2476&zoom=16',
    osmNodeId: 2345678901,
  ...
  },
  {
    ...
    osmMapsUrl: 'https://www.openstreetmap.org/?mlat=15.8800&mlon=108.3380&zoom=16',
    osmNodeId: 3456789012,
    mapProvider: 'openstreetmap',
    images: [],
    coverImage: '',
  ...
  },
  {
    ...
    osmMapsUrl: 'https://www.openstreetmap.org/?mlat=20.2562&mlon=105.5983&zoom=16',
    osmNodeId: 4567890123,
    mapProvider: 'openstreetmap',
    images: [],
    coverImage: '',
  ...
  },
  {
    ...
    osmMapsUrl: 'https://www.openstreetmap.org/?mlat=10.7725&mlon=106.6980&zoom=16',
    osmNodeId: 5678901234,
    mapProvider: 'openstreetmap',
    images: [],
    coverImage: '',
...
const settings = [
  {
    ...
    // ── Cấu hình map API ──────────────────────────────
    mapProvider: 'openstreetmap',                 // "google" | "openstreetmap"
